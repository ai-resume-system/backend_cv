...
export class addEventSystemAndRefreshTokensAndUpdateJobCVSchema1777825103662 implements MigrationInterface {
  name = 'addEventSystemAndRefreshTokensAndUpdateJobCVSchema1777825103662';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "outbox_events" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "aggregate_type" character varying(100) NOT NULL, "aggregate_id" uuid NOT NULL, "event_type" character varying(100) NOT NULL, "payload" jsonb NOT NULL DEFAULT '{}', "status" "public"."outbox_events_status_enum" NOT NULL DEFAULT 'pending', "retry_count" integer NOT NULL DEFAULT '0', "max_attempts" integer NOT NULL DEFAULT '3', "next_retry_at" TIMESTAMP, "locked_at" TIMESTAMP, "last_error" text, "processed_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_6689a16c00d09b8089f6237f1d2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE "jobs" ADD "short_description" text`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "cvs" ADD "processing_status" "public"."cvs_processing_status_enum" NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "jobs" DROP COLUMN "short_description"`,
    );
